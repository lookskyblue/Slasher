...
{
    private Action<string> on_change_alert_text_ui;
    ...
    public Action<string> On_Change_Alert_Text_UI
    {
        get { return on_change_alert_text_ui; }
        set { on_change_alert_text_ui = value; }
    }
